...
void H12qq::Fs(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = 0.25*M_1_PI*M_1_PI * ictx->alphasbar * ictx->ctx->CF * ictx->ctx->Sperp / ictx->z2 * ictx->qqfactor * ictx->S2r *
...
void H12qq::Fd(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = 0.75*M_1_PI*M_1_PI * ictx->alphasbar * ictx->ctx->CF * ictx->ctx->Sperp / ictx->z2 * ictx->qqfactor * ictx->S2r;
...
void H14qq::Fs(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = -0.25*M_1_PI*M_1_PI*M_1_PI * ictx->alphasbar * ictx->ctx->Nc * ictx->ctx->Sperp / ictx->z2 * ictx->qqfactor * ictx->S4rst
        * (1 + ictx->xi2) / ictx->xi
...
void H14qq::Fd(IntegrationContext* ictx, double* real, double* imag) {
    double realI, imagI;
    I1(ictx->kT * ictx->tx, &realI, &imagI);
    double amplitude = 0.25*M_1_PI*M_1_PI*M_1_PI * ictx->alphasbar * ictx->ctx->Nc * ictx->ctx->Sperp / ictx->z2 * ictx->qqfactor
...
void H14qqResidual::Fd(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = (1.0/6.0 - 0.625*M_1_PI*M_1_PI) * ictx->alphasbar * ictx->ctx->Nc * ictx->ctx->Sperp / ictx->z2 * ictx->qqfactor
...
void H02gg::Fd(IntegrationContext* ictx, double* real, double* imag) {
...
void H12gg::Fs(IntegrationContext* ictx, double* real, double* imag) {
...
void H12gg::Fn(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = 1/(4*M_PI*M_PI) * ictx->alphasbar * ictx->ggfactor / ictx->z2 * ictx->S2r * ictx->S2r *
...
void H12gg::Fd(IntegrationContext* ictx, double* real, double* imag) {
    double amplitude = 1/(4*M_PI*M_PI) * ictx->alphasbar * ictx->ggfactor / ictx->z2 * ictx->S2r * ictx->S2r;
...
void H12qqbarResidual::Fd(IntegrationContext* ictx, double* real, double* imag) {
...
void H16gg::Fs(IntegrationContext* ictx, double* real, double* imag) {
...
void H16gg::Fd(IntegrationContext* ictx, double* real, double* imag) {
    double realI, imagI;
...
void H16ggResidual::Fd(IntegrationContext* ictx, double* real, double* imag) {
...
void H112gq::Fn(IntegrationContext* ictx, double* real, double* imag) {
...
void H122gq::Fn(IntegrationContext* ictx, double* real, double* imag) {
...
void H112qg::Fn(IntegrationContext* ictx, double* real, double* imag) {
...
void H122qg::Fn(IntegrationContext* ictx, double* real, double* imag) {
